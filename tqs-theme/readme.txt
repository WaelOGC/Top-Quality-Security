...
== Setup ==
1. Package for upload: run package-theme.ps1 in the project root, OR zip the entire "tqs-theme" folder (not its inner files only). The zip must contain: tqs-theme/style.css at that path. Then upload via Appearance > Themes > Add New > Upload Theme, and Activate.
