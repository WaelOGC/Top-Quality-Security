...
<?php if ( ! tqs_should_hide_header() ) : ?>
	...
	<div class="tqs-topbar">
		...
		<div class="tqs-topbar-location">Den Haag, Nederland</div>
	</div>
	<?php endif; ?>
	...
	<header class="tqs-header">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="tqs-brand">
			<?php if ( has_custom_logo() ) : ?>
				<div class="tqs-brand-logo"><?php the_custom_logo(); ?></div>
			<?php else : ?>
				<div class="tqs-brand-logo">TQS</div>
			<?php endif; ?>
			<div>
				<div class="tqs-brand-text"><?php bloginfo( 'name' ); ?></div>
				<div class="tqs-brand-sub">BEVEILIGINGSDIENSTEN</div>
			</div>
		</a>
		...
		<a href="<?php echo esc_url( get_theme_mod( 'tqs_header_cta_url', '/contact' ) ); ?>" class="tqs-btn tqs-btn-gold tqs-header-cta"><?php echo esc_html( get_theme_mod( 'tqs_header_cta_text', 'Offerte Aanvragen' ) ); ?></a>
