...
<section class="tqs-page-hero">
	<div class="tqs-page-hero-inner">
		...
		<h1 class="tqs-page-title">Onze Diensten</h1>
		<p class="tqs-page-subtitle">Van winkelvloer tot evenemententerrein — TQS levert beveiligingsoplossingen op maat voor iedere sector, met gecertificeerd en professioneel personeel.</p>
	</div>
</section>
