...
<div class="tqs-contact-main">
	...
	<aside>
		...
		<div class="tqs-map-embed">
			<iframe src="https://www.google.com/maps?q=<?php echo rawurlencode( $address ); ?>&output=embed" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Google Maps"></iframe>
		</div>
	</aside>
</div>
